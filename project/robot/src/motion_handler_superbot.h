...
#ifndef PROJECT_ITERATION2_SRC_MOTION_HANDLER_SUPERBOT_H_
#define PROJECT_ITERATION2_SRC_MOTION_HANDLER_SUPERBOT_H_
 ...
 *
 * MotionHandlerSuperBot manages the modification to the velocity based on
...
class MotionHandlerSuperBot : public MotionHandler{
  ...
  *
  */
  void UpdateVelocity(SensorTouch st, SensorProximity sp, SensorEntityType se);
...
#endif   /* PROJECT_ITERATION2_SRC_MOTION_HANDLER_SUPERBOT_H_ */
