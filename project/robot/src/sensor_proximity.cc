...
bool SensorProximity::InRange(Range r1, Range r2) {
  ...
  if ((r2.lower >= r1.lower && r2.lower <= r1.upper)
      || (r2.lower + 360 >= r1.lower + 360 && r2.lower + 360 <= r1.upper + 360)
      || (r2.lower - 360 >= r1.lower - 360 && r2.lower - 360 <= r1.upper - 360)) {
    return true;
  }
  if ((r2.upper + 360 >= r1.lower + 360 && r2.upper + 360 <= r1.upper + 360)
      || (r2.upper >= r1.lower && r2.upper <= r1.upper)
      || (r2.upper - 360 >= r1.lower - 360 && r2.upper - 360 <= r1.upper - 360)) {
    return true;
  }
  return false;
}
