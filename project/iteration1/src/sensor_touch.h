...
/**
  * @brief Get the current point_of_contact from the sensor.
  */
  Position point_of_contact() { return point_of_contact_; }

/**
  * @brief Set the current point_of_contact from the sensor.
  */
...
/**
  * @brief Get the current angle_of_contact from the sensor.
  */
  double angle_of_contact(void) { return angle_of_contact_; }

/**
  * @brief Set the current angle_of_contact from the sensor.
  */
