...
class ArenaEntity {
  ...
  */
  ...
  /**
   * @brief Get the arena entity's distress sensor
   */
  virtual void get_distress() {}

  /**
   * @brief Judge the arena entity's distress
   */
  virtual int IsDistress() {}

  /**
   * @brief Set the arena entity's heading_angle_
   */
  virtual void set_heading_angle(double h) {}

  /**
   * @brief Get the arena entity's heading_angle_
   */
  virtual double get_heading_angle() {}

  /**
   * @brief Get the arena entity's type
   */
  ...
  /**
   * @brief Set the arena entity's type
   */
