...
#ifndef PROJECT_ITERATION3_SRC_MOTION_HANDLER_SUPERBOT_H_
#define PROJECT_ITERATION3_SRC_MOTION_HANDLER_SUPERBOT_H_
...
#endif   /* PROJECT_ITERATION3_SRC_MOTION_HANDLER_SUPERBOT_H_ */
