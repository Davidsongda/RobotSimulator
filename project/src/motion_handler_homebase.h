...
#ifndef PROJECT_ITERATION3_SRC_MOTION_HANDLER_HOMEBASE_H_
#define PROJECT_ITERATION3_SRC_MOTION_HANDLER_HOMEBASE_H_
...
#endif   /* PROJECT_ITERATION3_SRC_MOTION_HANDLER_HOMEBASE_H_ */
