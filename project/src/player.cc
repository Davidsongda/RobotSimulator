...
void Player::Accept(__unused EventDespeed * e) {
  motion_handler_.EventDespeed();
}

void Player::Accept(__unused EventDebattery * e) {
  battery_.EventDebattery();
}
