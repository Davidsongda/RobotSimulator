...
int main(int argc, char * argv[]) {
  ...
  while (getline(configfile, line)) {
    ...
    if (cmd == "Obstacle") {
      ...
      int cd, t, r, g, b, a;
      sscanf(line.c_str(), "Player %f %f %f %f %f %d %d %d %d %d %d", &x,
      &y, &rod, &bmc, &ad, &cd, &t, &r, &g, &b, &a);
      ...
      float x, y, rod, ad, cd;
      int t, r, g, b, a;
      sscanf(line.c_str(), "HomeBase %f %f %f %f %f %d %d %d %d %d", &x,
      &y, &rod, &ad, &cd, &t, &r, &g, &b, &a);
      ...
      float x, y, rod;
      int t, r, g, b, a;
      sscanf(line.c_str(), "RechargeStation %f %f %f %d %d %d %d %d", &x,
      &y, &rod, &t, &r, &g, &b, &a);
